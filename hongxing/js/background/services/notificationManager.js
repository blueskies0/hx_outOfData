    ...
    n = ["angular", "core/services/storage", "core/services/pageUtils", "core/services/timeUtils", "background/module", "background/services/track"], i = function (n) {
        ...
        return notificationManager = function ($rootScope, $translate, $http, $timeout, storage, server, timeUtils, pageUtils, track, ROLES, SERVER) {
            ...
            return chrome.notifications ? (o = {}, i = function () {
                ...
                var n, i, e;
                return n = {options: {title: $translate.instant("notifications.create_vip.title"), message: $translate.instant("notifications.create_vip.message"), contextMessage: $translate.instant("notifications.create_vip.contextMessage"), type: "basic", iconUrl: "img/logo.png"}, type: "Please Create VIP", url: "https://" + SERVER + "/pay/index?name=" + (null != (i = $rootScope.user) && null != (e = i.profile) ? e.name : void 0)}, chrome.notifications.create("notifyCreateVIP", n.options, function (i) {
                    return o[i] = n
                }), track.event("notification", n.type, "show")
            }, r = function () {
                var n, i, e;
                return n = {options: {title: $translate.instant("notifications.renew_vip.title"), message: $translate.instant("notifications.renew_vip.message"), contextMessage: $translate.instant("notifications.renew_vip.contextMessage"), buttons: [
                    {title: $translate.instant("notifications.renew_vip.button_title")}
                ], type: "basic", iconUrl: "img/logo.png"}, type: "Please Renew VIP", url: "https://" + SERVER + "/pay/index?name=" + (null != (i = $rootScope.user) && null != (e = i.profile) ? e.name : void 0)}, chrome.notifications.create("notifyRenewVIP", n.options, function (i) {
                    return o[i] = n
                }), track.event("notification", n.type, "show")
            }, n = function (n) {
                var i, e;
                return null == n && (n = null), $http.get("https://" + SERVER + "/user/notification", {params: {sid: null != (i = $rootScope.user) && null != (e = i.profile) ? e.sid : void 0, nid: n}}).success(function (n) {
                    var i, e, r, s, a;
                    if (n.notifications) {
