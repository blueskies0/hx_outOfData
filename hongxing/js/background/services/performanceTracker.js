(function () {
    ...
    e = ["underscore", "debug", "angular", "core/services/storage", "core/services/timeUtils", "core/services/domainUtils", "background/module", "background/services/proxyManager"], r = function (e, r, n) {
        ...
        return a = r("performanceTracker"), performanceTracker = function ($rootScope, $timeout, $http, proxyManager, storage, timeUtils, domainUtils, ROLES, LOG_URL) {
            ...
            return c = {}, l = {id: "", url: "", proxy: "", timeSendHeaders: -1, timeHeadersReceived: -1, timeEnded: -1, contentLength: 0, error: "", type: "latency"}, i = function () {
                ...
                var n, a, i, o;
                o = [];
                for (a in r)i = r[a], n = {event: "proxy." + a, data: {sid: $rootScope.user.profile.sid, proxy: e}}, n.data[a] = i, o.push($http({method: "POST", url: LOG_URL, data: n}));
                return o
            }, r = function (e) {
                var r, n, i;
                if ("speed" === e.type) {
