(function () {
    ...
    e = ["debug", "angular", "core/services/domainUtils", "background/module", "background/services/proxyManager"], r = function (e, r) {
        ...
        return u = e("errorPageCustomizer"), errorPageCustomizer = function ($rootScope, domainUtils, proxyManager, ROLES, ERROR_PAGE_PROXY) {
            var e, r, l, n, s, o, a;
            return a = {}, r = function () {
                return null == $rootScope.urlRules && ($rootScope.urlRules = {}), chrome.webRequest.onErrorOccurred.addListener(s, {urls: ["<all_urls>"], types: ["main_frame"]}), chrome.webRequest.onCompleted.addListener(n, {urls: ["<all_urls>"], types: ["main_frame"]}), chrome.webRequest.onBeforeSendHeaders.addListener(l, {urls: ["http://*/*"]}, ["blocking", "requestHeaders"]), u("ready")
            }, e = function (e, r) {
                var l;
                ...
                var r, u;
                if (a[e.url] && (null != $rootScope && null != (r = $rootScope.user) && null != (u = r.profile) ? u.name : void 0))return e.requestHeaders.push({name: "X-Error", value: a[e.url]}), e.requestHeaders.push({name: "X-name", value: $rootScope.user.profile.name}), {requestHeaders: e.requestHeaders}
            }, s = function (r) {
                var l, n;
