(function () {
    ...
    e = ["angular", "core/module", "core/services/tele", "core/services/pageUtils", "core/services/storage", "login/module"], r = function (e) {
        ...
        return r = function ($rootScope, $scope, $http, $timeout, tele, pageUtils, storage, SERVER, ERROR_LOGIN_UNKNOWN, ERROR_LOGIN_TIME, LOGIN_EVENT_NAME) {
            return $scope.name = "", $scope.password = "", $scope.password2 = "", $scope.focuses = {name: !0, password: !1, password2: !1}, $scope.submitting = !1, $scope.checkingName = !1, $scope.clearNameValidity = function () {
                ...
                {
                    if ($scope.register.$valid)return $scope.submitting = !0, $http.get("https://" + SERVER + "/user/register", {params: {name: $scope.name, password: $scope.password}}).success(function (e) {
                        var r, n;
