    ...
    e = ["debug", "angular", "core/module", "core/services/generate"], r = function (e, r) {
        ...
        return tele = function ($rootScope, $q, $timeout, generate) {
            ...
            return w = generate.randomId(8), f = e("tele [" + w + "]"), d = e("tele [" + w + "]"), d.log = console.error.bind(console), a = {}, v = {}, m = function (e, r) {
                var n;
                return n = {senderId: w, id: generate.randomId(8), command: "tele.run", type: "request", name: e, args: r}, chrome.runtime.sendMessage(n), f("~f> [%s] %s(%o)", n.id, e, r), n
            }, k = function (e, r) {
                var n;
                return n = {senderId: w, id: e.id, command: "tele.run", type: "response"}, r.error ? (n.error = r.error, d("=f> [%s] %o", e.id, n.error)) : (n.result = r.result, f("=f> [%s] %o", e.id, n.result)), chrome.runtime.sendMessage(n), n
            }, h = function (e) {
                var r, n, o;
                o = [];
                ...
                var e, r, o, s;
                return o = arguments[0], e = 2 <= arguments.length ? n.call(arguments, 1) : [], s = m(o, e), r = $q.defer(), v[s.id] = {request: s, deferred: r}, $timeout(function () {
                    return v[s.id] ? (delete v[s.id], r.reject("timeout"), d("=f> %o", s.id, "timeout")) : void 0
                }, 3e3), r.promise
            }, g = {}, o = function (e) {
                var r;
                return r = {senderId: w, command: "tele.scope", type: "ask", key: e}, chrome.runtime.sendMessage(r), f("~s> [%s]", e)
            }, i = function (e, r) {
                var n;
                return n = {senderId: w, command: "tele.scope", type: "emit", key: e, value: r}, chrome.runtime.sendMessage(n), f("=s> [%s] %o", e, r)
            }, u = function (e, r) {
                var n;
                return n = {senderId: w, command: "tele.scope", type: "emit", key: e, delta: r}, chrome.runtime.sendMessage(n), f("=s> [%s %o", e, r)
            }, c = function (e, n) {
                ...
                var n, s;
                return null == r && (r = void 0), n = $q.defer(), null == g[e] && (g[e] = {ready: !1, defers: [], owner: (null != r ? r.owner : void 0) || !1, list: (null != r ? r.list : void 0) || !1, unwatch: null, mute: !1}), s = g[e], s.ready ? (setTimeout(function () {
