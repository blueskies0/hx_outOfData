(function () {
    ...
    r = ["angular", "angular_translate", "core/module", "core/services/validate", "core/services/invitationManager"], e = function (r) {
        ...
        return e = function ($rootScope, $http, $timeout, $tooltip, $translate, invitationManager, validate, SERVER) {
            return{restrict: "E", scope: {focusTrigger: "=manualFocus"}, templateUrl: "partials/options/_inviter_input.html", link: function (r, e) {
                return r.tooltipText = "", r.tempInviter = "", r.$watch("focusTrigger", function (n) {
                    ...
                    var i;
                    return i = e.children("form").children("input"), r.myTooltip = $tooltip(i, {title: n, placement: "bottom", trigger: "manual"}), $timeout(function () {
                    ...
                    var e;
                    return e = r.tempInviter.trim(), validate.email(e) || validate.phone(e) ? $http({method: "POST", url: "https://" + SERVER + "/user/set_inviter", params: {inviter: e, sid: $rootScope.user.profile.sid}, headers: {"Content-Type": "application/x-www-form-urlencoded"}}).success(function (n) {
