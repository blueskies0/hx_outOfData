(function () {
    ...
    e = ["underscore", "debug", "angular", "lang", "angular_translate", "core/module", "core/filters/durationToNow", "core/directives/domain", "core/directives/equals", "core/directives/focusBind", "core/directives/formState", "core/directives/inviterInput", "core/directives/resizeIframe", "core/services/invitationManager", "core/services/corruptDetector", "options/controllers/OptionsPageController", "options/controllers/TradeListController", "options/controllers/DomainListController", "options/controllers/InvitationController", "options/controllers/ProfileController", "options/controllers/ChangePasswordController", "options/controllers/ChangePasswordModalController"], o = function (e, o, r, n) {
        ...
        return i = o("options"), r.module("options").run(function ($templateCache) {
            ...
            return $compileProvider.aHrefSanitizationWhitelist(/^\s*(http|https?|ftp|mailto|chrome-extension):/), $compileProvider.imgSrcSanitizationWhitelist(/^\s*(https?|data|chrome-extension):/), r.extend($dropdownProvider.defaults, {template: "dropdown/safeDropdown.tpl.html"}), $urlRouterProvider.when("/", "/domains"), $stateProvider.state("main", {url: "/", templateUrl: "/partials/options/layout.html", controller: "OptionsPageController", resolve: {user: function (tele) {
                return tele.scope("user")
            }, averageStability: function (tele) {
                return tele.scope("averageStability")
            }}}).state("main.trades", {url: "trades", templateUrl: "/partials/options/trade_list.html", controller: "TradeListController"}).state("main.domains", {url: "domains", templateUrl: "/partials/options/domain_list.html", controller: "DomainListController"}).state("main.invitations", {url: "invitations", templateUrl: "/partials/options/invitation.html", controller: "InvitationController"}).state("main.blog", {url: "blog", templateUrl: "/partials/options/blog.html"}), $urlRouterProvider.otherwise("domains"), n.config($translateProvider)
